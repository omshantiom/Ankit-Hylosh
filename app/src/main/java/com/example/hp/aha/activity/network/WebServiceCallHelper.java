...
public class WebServiceCallHelper {
    ...
    public static void submitHomeFragmentSearchTitle(Context context, ObserverCallBack myObserver,
                                                     String title,String latitude,String longitude) {
        WebApiInterface apiService = ApiClient.getClient(context).create(WebApiInterface.class);
        Observable<ResponseBody> responseObservable = apiService.User_Submit_Home_Fragment_Search_Title
