...
public interface WebApiInterface {
    ...
    //URL: https://13.233.41.0/rest/V1/advance/search/
    @GET("advance/search")
    Observable<ResponseBody> User_Submit_Home_Fragment_Search_Title(@Query("title") String title,@Query("latitude") String latitude,
